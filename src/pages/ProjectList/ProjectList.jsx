         ...
         <div className="flex justify-between lg:w-[20rem]">
                            ...
                            <div className='pt-5'>
                                <RadioGroup className="space-y-3 pt-3" defaultvalue="all" onValueChange={(value)=>handleFilterChange("category",value)}>
                                    <div className="flex items-center gap-2">
                                        <RadioGroupItem value='all' id="r1" /> {/* Ensure RadioGroupItem is imported */}
                                        <Label htmlFor="r1">All</Label>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <RadioGroupItem value='fullstack' id="r2" /> {/* Ensure RadioGroupItem is imported */}
                                        <Label htmlFor="r2">fullstack</Label>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <RadioGroupItem value='frontend' id="r3" /> {/* Ensure RadioGroupItem is imported */}
                                        <Label htmlFor="r3">frontend</Label>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <RadioGroupItem value='backend' id="r4" /> {/* Ensure RadioGroupItem is imported */}
            ...
            <div className="relative p-0 w-full">
                  <Input 
                    ...
                    className="40%  px=9" />
                <MagnifyingGlassIcon className="absolute top-3 left-0"/>
